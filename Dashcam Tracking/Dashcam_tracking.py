...
trained_car_data = cv2.CascadeClassifier("Dashcam Tracking\car_detector.xml")
trained_pedestrian_data =cv2.CascadeClassifier("Dashcam Tracking\pedestrian_detector.xml")
trained_bus_data = cv2.CascadeClassifier("Dashcam Tracking\bus_detector.xml")
trained_bike_data = cv2.CascadeClassifier("Dashcam Tracking\bike_detector.xml")
